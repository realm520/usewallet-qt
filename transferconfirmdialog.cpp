...
//    ui->pwdLineEdit->setPlaceholderText( QString::fromLocal8Bit("请输入登录口令"));
...
void TransferConfirmDialog::on_okBtn_clicked()
    ...
    Blockchain::getInstance()->postRPC( toJsonFormat( "id_wallet_check_passphrase", "wallet_check_passphrase", QStringList() << ui->pwdLineEdit->text()
                                               ));
